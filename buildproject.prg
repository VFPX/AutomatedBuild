...
#endif
*=================================================================
* Original code is from CoDe Magazine titled "Integrating VFP into
* VSTS Team Projects" by John Miller (jmiller@pdata.com).
*
* Extended for FinalBuilder by Kok Kiet
* (http://weblogs.foxite.com/kkchan/archive/2007/08/28/4763.aspx).
*
* Further extended for CruiseControl.NET, cleaned up,
* commented and formatted by Markus Winhard (mw@bingo-ev.de).
*=================================================================
